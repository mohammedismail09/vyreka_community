...
import founderImg from "../../public/team/founder.jpg";
import pradeepImg from "../../public/team/pradeep.jpeg";
import saikiranImg from "../../public/team/saikiran.jpeg";
import ismailImg from "../../public/team/ismail.jpeg";
...
export default function HomePage() {
  ...
  return (
    <main className="pt-20 dark:bg-background">
      ...
      {/* --- WHY CHOOSE VYREKA SECTION WITH MOBILE CAROUSEL --- */}
      <section className="py-stack-xl overflow-hidden">
        <div className="mx-auto w-full max-w-container-max px-margin-mobile md:px-margin-desktop">
          ...
          <div className="scrollbar-hide -mx-margin-mobile flex snap-x snap-mandatory overflow-x-auto px-margin-mobile pb-4 gap-gutter flex-nowrap md:mx-0 md:grid md:grid-cols-3 md:overflow-visible md:p-0 md:flex-wrap">
            {valueCards.map((card) => (
              <div
                key={card.title}
                className="glass-card group min-w-[280px] max-w-[320px] shrink-0 snap-center rounded-xl border border-gray-100 bg-gray-50/50 p-stack-lg text-gray-900 transition-all duration-300 hover:-translate-y-2 dark:border-white/5 dark:bg-transparent dark:text-on-surface md:min-w-0 md:max-w-none md:shrink md:snap-align-none"
              >
                <div
...
{!eventsLoading && latestEvent && (
            ...
            <div className="spotlight-box relative overflow-hidden rounded-3xl border border-indigo-100 bg-purple-100 p-stack-lg dark:border-primary/20 dark:bg-primary-container/10 md:p-stack-xl">
              ...
              <div className="grid items-center gap-stack-xl md:grid-cols-2">
                <div className="text-gray-900 dark:text-on-surface">
                  ...
                  {/* Added line clamping classes here */}
                  <p className="spotlight-p mb-stack-lg text-body-lg text-gray-600 dark:text-on-surface-variant line-clamp-2 md:line-clamp-none">
      ...
      {/* --- SPECIALIZED COMMUNITY ECOSYSTEM SECTION WITH MOBILE CAROUSEL --- */}
      <section className="py-stack-xl overflow-hidden">
        <div className="mx-auto w-full max-w-container-max px-margin-mobile md:px-margin-desktop">
          ...
          <div className="scrollbar-hide -mx-margin-mobile flex snap-x snap-mandatory overflow-x-auto px-margin-mobile pb-4 gap-6 flex-nowrap sm:grid sm:grid-cols-2 sm:overflow-visible sm:p-0 sm:flex-wrap lg:mx-0 lg:grid-cols-3">
            {ecosystemItems.map((item) => (
              <div
                key={item.title}
                className={`glass-card min-w-[280px] max-w-[320px] shrink-0 snap-center rounded-2xl border border-gray-100 bg-gray-50/50 p-8 text-gray-900 transition-colors dark:border-white/5 dark:bg-transparent dark:text-on-surface sm:min-w-0 sm:max-w-none sm:shrink sm:snap-align-none ${item.color}`}
              >
                <span
...
{/* --- MEET THE LEADERSHIP SECTION WITH MOBILE CAROUSEL --- */}
      <section className="team-section bg-gray-50 py-stack-xl transition-colors duration-300 dark:bg-surface-container-high/30 overflow-hidden">
        <div className="mx-auto w-full max-w-container-max space-y-12 px-margin-mobile md:px-margin-desktop">
          ...
          <div className="scrollbar-hide -mx-margin-mobile flex snap-x snap-mandatory overflow-x-auto px-margin-mobile pb-4 gap-gutter flex-nowrap sm:grid sm:grid-cols-2 sm:overflow-visible sm:p-0 sm:flex-wrap lg:mx-0 lg:grid-cols-4">
            {leadership.map((person) => (
              <div
                key={person.name}
                className="group text-center text-gray-900 dark:text-on-surface min-w-[200px] max-w-[240px] shrink-0 snap-center sm:min-w-0 sm:max-w-none sm:shrink sm:snap-align-none"
              >
